...
class SimService : IntentService("SimService") {
    companion object {
...
//    class SMSReadTask : AsyncTask<(UartDevice)->Unit, Unit, Unit>() {
//        var uartDevice: UartDevice? = null
//        override fun doInBackground(vararg argArray: ((UartDevice) -> Unit)?) {
//            android.util.Log.d(TAG, "SMSReadTask")
//
//            while (true) {
//                android.util.Log.d(TAG, "TICK")
//                argArray[0]!!.invoke(uartDevice!!)
//                Thread.sleep(5000)
//            }
//        }
//    }
